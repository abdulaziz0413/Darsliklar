...
namespace telegram_bot_subscriber
{
    public class Program
    {
        ...
        async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            ...
            var botClientDev = new TelegramBotClient("6843753914:AAGsyVIyyhWGrsW9wgoiT4mGAtVCj1n_p9E");
            ...
            if (messageText != null && int.Parse(day.ToString()) >= day && int.Parse(hour.ToString()) >= hour && int.Parse(minute.ToString()) >= minute && int.Parse(second.ToString()) >= second - 10)
            {
                ...
                if (messageText == "/start")
                {
                    ...
                    var getchatmember = await botClient.GetChatMemberAsync(/*ID or NAME of the chat*/"@dotNetdev_abdulaziz",/*user id*/ id);
                    var getchatmember2 = await botClient.GetChatMemberAsync(/*ID or NAME of the chat*/"@DotNetBotN11_1_bot",/*user id*/ id);
